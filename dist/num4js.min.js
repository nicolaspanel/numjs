...
}),p=h.map(function(a){return"c"+a+"=this.stride["+a+"]"});f.push("proto.lo=function "+c+"_lo("+j.join(",")+"){var b=this.offset,d=0,"+o.join(",")+","+p.join(","));for(var q=0;b>q;++q)f.push("if(typeof i"+q+"==='number'&&i"+q+">=0){d=i"+q+"|0;b+=c"+q+"*d;a"+q+"-=d}");f.push("return new "+c+"(this.data,"+h.map(function(a){return"a"+a}).join(",")+","+h.map(function(a){return"c"+a}).join(",")+",b)}"),f.push("proto.step=function "+c+"_step("+j.join(",")+"){var "+h.map(function(a){return"a"+a+"=this.shape["+a+"]"}).join(",")+","+h.map(function(a){return"b"+a+"=this.stride["+a+"]"}).join(",")+",c=this.offset,d=0,ceil=Math.ceil");for(var q=0;b>q;++q)f.push("if(typeof i"+q+"==='number'){d=i"+q+"|0;if(d<0){c+=b"+q+"*(a"+q+"-1);a"+q+"=ceil(-a"+q+"/d)}else{a"+q+"=ceil(a"+q+"/d)}b"+q+"*=d}");f.push("return new "+c+"(this.data,"+h.map(function(a){return"a"+a}).join(",")+","+h.map(function(a){return"b"+a}).join(",")+",c)}");for(var r=new Array(b),s=new Array(b),q=0;b>q;++q)r[q]="a[i"+q+"]",s[q]="b[i"+q+"]";f.push("proto.transpose=function "+c+"_transpose("+j+"){"+j.map(function(a,b){return a+"=("+a+"===undefined?"+b+":"+a+"|0)"}).join(";"),"var a=this.shape,b=this.stride;return new "+c+"(this.data,"+r.join(",")+","+s.join(",")+",this.offset)}"),f.push("proto.pick=function "+c+"_pick("+j+"){var a=[],b=[],c=this.offset");for(var q=0;b>q;++q)f.push("if(typeof i"+q+"==='number'&&i"+q+">=0){c=(c+this.stride["+q+"]*i"+q+")|0}else{a.push(this.shape["+q+"]);b.push(this.stride["+q+"])}");f.push("var ctor=CTOR_LIST[a.length+1];return ctor(this.data,a,b,c)}"),f.push("return function construct_"+c+"(data,shape,stride,offset){return new "+c+"(data,"+h.map(function(a){return"shape["+a+"]"}).join(",")+","+h.map(function(a){return"stride["+a+"]"}).join(",")+",offset)}");var g=new Function("CTOR_LIST","ORDER",f.join("\n"));return g(l[a],e)}function g(a){if(j(a))return"buffer";if(k)switch(Object.prototype.toString.call(a)){case"[object Float64Array]":return"float64";case"[object Float32Array]":return"float32";case"[object Int8Array]":return"int8";case"[object Int16Array]":return"int16";case"[object Int32Array]":return"int32";case"[object Uint8Array]":return"uint8";case"[object Uint16Array]":return"uint16";case"[object Uint32Array]":return"uint32";case"[object Uint8ClampedArray]":return"uint8_clamped"}return Array.isArray(a)?"array":"generic"}function h(a,b,c,d){if(void 0===a){var e=l.array[0];return e([])}"number"==typeof a&&(a=[a]),void 0===b&&(b=[a.length]);var h=b.length;if(void 0===c){c=new Array(h);for(var i=h-1,j=1;i>=0;--i)c[i]=j,j*=b[i]}if(void 0===d){d=0;for(var i=0;h>i;++i)c[i]<0&&(d-=(b[i]-1)*c[i])}for(var k=g(a),m=l[k];m.length<=h+1;)m.push(f(k,m.length-1));var e=m[h+1];return e(a,b,c,d)}var i=a("iota-array"),j=a("is-buffer"),k="undefined"!=typeof Float64Array,l={float32:[],float64:[],int8:[],int16:[],int32:[],uint8:[],uint16:[],uint32:[],array:[],uint8_clamped:[],buffer:[],generic:[]};b.exports=h},{"iota-array":13,"is-buffer":14}],21:[function(a,b,c){(function(b,d){"use strict";function e(a){if(a){var b=a.length||a.byteLength,c=s.log2(b);w[c].push(a)}}function f(a){e(a.buffer)}function g(a){var a=s.nextPow2(a),b=s.log2(a),c=w[b];return c.length>0?c.pop():new ArrayBuffer(a)}function h(a){return new Uint8Array(g(a),0,a)}function i(a){return new Uint16Array(g(2*a),0,a)}function j(a){return new Uint32Array(g(4*a),0,a)}function k(a){return new Int8Array(g(a),0,a)}function l(a){return new Int16Array(g(2*a),0,a)}function m(a){return new Int32Array(g(4*a),0,a)}function n(a){return new Float32Array(g(4*a),0,a)}function o(a){return new Float64Array(g(8*a),0,a)}function p(a){return u?new Uint8ClampedArray(g(a),0,a):h(a)}function q(a){return new DataView(g(a),0,a)}function r(a){a=s.nextPow2(a);var b=s.log2(a),c=x[b];return c.length>0?c.pop():new d(a)}var s=a("bit-twiddle"),t=a("dup");b.__TYPEDARRAY_POOL||(b.__TYPEDARRAY_POOL={UINT8:t([32,0]),UINT16:t([32,0]),UINT32:t([32,0]),INT8:t([32,0]),INT16:t([32,0]),INT32:t([32,0]),FLOAT:t([32,0]),DOUBLE:t([32,0]),DATA:t([32,0]),UINT8C:t([32,0]),BUFFER:t([32,0])});var u="undefined"!=typeof Uint8ClampedArray,v=b.__TYPEDARRAY_POOL;v.UINT8C||(v.UINT8C=t([32,0])),v.BUFFER||(v.BUFFER=t([32,0]));var w=v.DATA,x=v.BUFFER;c.free=function(a){if(d.isBuffer(a))x[s.log2(a.length)].push(a);else{if("[object ArrayBuffer]"!==Object.prototype.toString.call(a)&&(a=a.buffer),!a)return;var b=a.length||a.byteLength,c=0|s.log2(b);w[c].push(a)}},c.freeUint8=c.freeUint16=c.freeUint32=c.freeInt8=c.freeInt16=c.freeInt32=c.freeFloat32=c.freeFloat=c.freeFloat64=c.freeDouble=c.freeUint8Clamped=c.freeDataView=f,c.freeArrayBuffer=e,c.freeBuffer=function(a){x[s.log2(a.length)].push(a)},c.malloc=function(a,b){if(void 0===b||"arraybuffer"===b)return g(a);switch(b){case"uint8":return h(a);case"uint16":return i(a);case"uint32":return j(a);case"int8":return k(a);case"int16":return l(a);case"int32":return m(a);case"float":case"float32":return n(a);case"double":case"float64":return o(a);case"uint8_clamped":return p(a);case"buffer":return r(a);case"data":case"dataview":return q(a);default:return null}return null},c.mallocArrayBuffer=g,c.mallocUint8=h,c.mallocUint16=i,c.mallocUint32=j,c.mallocInt8=k,c.mallocInt16=l,c.mallocInt32=m,c.mallocFloat32=c.mallocFloat=n,c.mallocFloat64=c.mallocDouble=o,c.mallocUint8Clamped=p,c.mallocDataView=q,c.mallocBuffer=r,c.clearCache=function(){for(var a=0;32>a;++a)v.UINT8[a].length=0,v.UINT16[a].length=0,v.UINT32[a].length=0,v.INT8[a].length=0,v.INT16[a].length=0,v.INT32[a].length=0,v.FLOAT[a].length=0,v.DOUBLE[a].length=0,v.UINT8C[a].length=0,w[a].length=0,x[a].length=0}}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{},a("buffer").Buffer)},{"bit-twiddle":2,buffer:3,dup:10}],22:[function(a,b,c){"use strict";function d(a,b){for(var c=1,d=a.length,e=a[0],f=a[0],g=1;d>g;++g)if(f=e,e=a[g],b(e,f)){if(g===c){c++;continue}a[c++]=e}return a.length=c,a}function e(a){for(var b=1,c=a.length,d=a[0],e=a[0],f=1;c>f;++f,e=d)if(e=d,d=a[f],d!==e){if(f===b){b++;continue}a[b++]=d}return a.length=b,a}function f(a,b,c){return 0===a.length?a:b?(c||a.sort(b),d(a,b)):(c||a.sort(),e(a))}b.exports=f},{}],23:[function(a,b,c){"use strict";b.exports={ValueError:function(){var a=Error.apply(this,arguments);return a.name=this.constructor.name,a},ConfigError:function(){var a=Error.apply(this,arguments);return a.name=this.constructor.name,a},NotImplementedError:function(){var a=Error.apply(this,arguments);return a.name=this.constructor.name,a}}},{}],24:[function(a,b,c){"use strict";function d(a){return"number"==typeof a}function e(a){return"string"==typeof a}function f(a){return"function"==typeof a}function g(a,b,c){c=c||[];for(var e=-1,f=a.length;++e<f;){var h=a[e];d(h)?c[c.length]=h:b?g(h,b,c):c.push(h)}return c}function h(a,b){b=b||0;var c=0|a[b];if(0>=c)return[];var d,e=new Array(c);if(b===a.length-1)for(d=0;c>d;++d)e[d]=0;else for(d=0;c>d;++d)e[d]=h(a,b+1);return e}function i(a){var b=h(a.shape,0);return ga(a,b),b}function j(a){for(var b=1,c=0;c<a.length;c++)b*=a[c];return b}function k(a){for(var b=[];"object"==typeof a;)b.push(a.length),a=a[0];return b}function l(a){var b,c;return"object"==typeof a?(b=a[0],"object"==typeof b?(c=b[0],"object"==typeof c?k(a):[a.length,b.length]):[a.length]):[]}function m(a){return f(a)?a:fa[a]||Array}function n(a,b){if(0!==a.length&&0!==b.length){for(var c=a.slice().reverse(),d=b.slice().reverse(),e=Math.max(a.length,b.length),f=new Array(e),g=0;e>g;g++)if(c[g]&&1!==c[g])if(d[g]&&1!==d[g]){if(c[g]!==d[g])return;f[g]=c[g]}else f[g]=c[g];else f[g]=d[g];return f.reverse()}}function o(a,b){return F(a).add(b)}function p(a,b){return F(a).multiply(b)}function q(a,b){return F(a).divide(b)}function r(a,b){return F(a).subtract(b)}function s(a){return F(a).max()}function t(a){return F(a).min()}function u(a,b){return F(a).equal(b)}function v(a){return F(a).flatten()}function w(a,b){return F(a).reshape(b)}function x(a){return F(a).exp()}function y(a){var b=a instanceof ha?a.clone():F(a);return _.sqrteq(b.selection),b}function z(a,b){return F(a).pow(b)}function A(a){return F(a).sum()}function B(a){return F(a).mean()}function C(a){return F(a).std()}function D(a,b){return F(a).transpose(b)}function E(a){return F(a).negative()}function F(a,b){if(a instanceof ha)return a;var c=m(b);if(d(a))return c!==Array?new ha(new c([a]),[1]):new ha([a],[1]);var e=l(a);return e.length>1&&(a=g(a,!0)),a instanceof c||(a=new c(a)),new ha(a,e)}function G(a,b,c,e){1===arguments.length?(b=a,a=0,c=1):2===arguments.length&&d(b)?c=1:2===arguments.length?(e=b,b=a,a=0,c=1):3!==arguments.length||d(c)||(e=c,c=1);for(var f=[],g=0;b>a;)f[g++]=a,a+=c;return F(f,e)}function H(a,b){d(a)&&a>=0&&(a=[a]);var c=j(a),e=m(b),f=new ha(new e(c),a);return _.assigns(f.selection,0),f}function I(a,b){d(a)&&a>=0&&(a=[a]);var c=j(a),e=m(b),f=new ha(new e(c),a);return _.assigns(f.selection,1),f}function J(a){if(0===arguments.length)return F(Math.random());a=1===arguments.length?d(a)?[0|a]:a:arguments;var b=j(a),c=new ha(new Array(b),a);return _.random(c.selection),c}function K(a){var b=F(a).exp(),c=b.sum();return _.divseq(b.selection,c),b}function L(a,b){return a=F(a).clone(),b=b||1,ia(a.selection,b),a}function M(a,b,c){1===arguments.length?(b=0,c=1):2===arguments.length&&(c=1);var d=a instanceof ha?a.clone():F(a);return ja(d.selection,b,c),d}function N(a,b){b=b||.001;var c=a instanceof ha?a.clone():F(a);return ka(c.selection,b),c}function O(a){var b=a instanceof ha?a.clone():F(a);return la(b.selection),b}function P(a){var b=a instanceof ha?a.clone():F(a);return _.abseq(b.selection),b}function Q(a){var b=a instanceof ha?a.clone():F(a);return _.coseq(b.selection),b}function R(a){var b=a instanceof ha?a.clone():F(a);return _.acoseq(b.selection),b}function S(a){var b=a instanceof ha?a.clone():F(a);return _.sineq(b.selection),b}function T(a){var b=a instanceof ha?a.clone():F(a);return _.asineq(b.selection),b}function U(a){var b=a instanceof ha?a.clone():F(a);return _.taneq(b.selection),b}function V(a){var b=a instanceof ha?a.clone():F(a);return _.ataneq(b.selection),b}function W(a,b){a=F(a),b=F(b);var c,d,e=a.shape,f=b.shape,g=m(a.dtype);if(2===e.length&&2===f.length&&e[1]===f[0])return c=[e[0],f[1]],d=new ha(new g(j(c)),c),ba(d.selection,a.selection,b.selection),d;if(1===e.length&&2===f.length&&e[0]===f[0])return W(a.reshape([e[0],1]).transpose(),b).reshape(f[1]);if(2===e.length&&1===f.length&&e[1]===f[0])return W(a,b.reshape([f[0],1])).reshape(e[0]);if(1===e.length&&1===f.length&&e[0]===f[0])return W(a.reshape([e[0],1]).transpose(),b.reshape([f[0],1])).reshape([1]);throw new aa.ValueError("cannot compute the matrix product of given arrays")}function X(a,b){var c,e;for(c=0;c<a.length;c++)e=a[c],a[c]=e instanceof ha?e.tolist():d(e)?[e]:e;var f=a[0];for(c=1;c<a.length;c++){e=a[c];var g=l(f),h=l(e);if(g.length!==h.length)throw new aa.ValueError("all the input arrays must have same number of dimensions");if(1===g.length&&1===h.length)f=f.concat(e);else if(2===g.length&&2===h.length&&g[0]===h[0]||1===g.length&&2===h.length&&g[0]===h[0]||2===g.length&&1===h.length&&g[0]===h[0])for(var i=0;i<g[0];i++)f[i]=f[i].concat(e[i]);else{if(!(3===g.length&&3===h.length&&g[0]===h[0]&&g[1]===h[1]||2===g.length&&3===h.length&&g[0]===h[0]&&g[1]===h[1]||3===g.length&&2===h.length&&g[0]===h[0]&&g[1]===h[1]))throw new aa.ValueError('cannot concatenate  "'+g+'" with "'+h+'"');for(var j=0;j<g[0];j++){for(var k=new Array(g[1]),m=0;m<g[1];m++)k[m]=f[j][m].concat(e[j][m]);f[j]=k}}}return F(f,b)}var Y=a("iota-array"),Z=a("ndarray"),$=a("cwise"),_=a("ndarray-ops"),aa=a("./errors"),ba=a("ndarray-gemm"),ca=a("ndarray-fft"),da=a("typedarray-pool"),ea={printThreshold:5},fa={int8:Int8Array,int16:Int16Array,int32:Int32Array,uint8:Uint8Array,uint16:Uint16Array,uint32:Uint32Array,float32:Float32Array,float64:Float64Array},ga=$({args:["array","scalar","index"],body:function(a,b,c){var d,e=b;for(d=0;d<c.length-1;++d)e=e[c[d]];e[c[c.length-1]]=a}}),ha=function(a,b,c,d){if(1===arguments.length)this.selection=a;else{if(0===arguments.length)throw new aa.ValueError("Required argument 'data' not found");this.selection=Z(a,b,c,d)}Object.defineProperty(this,"size",{get:function(){return this.selection.size}.bind(this)}),Object.defineProperty(this,"shape",{get:function(){return this.selection.shape}.bind(this)}),Object.defineProperty(this,"ndim",{get:function(){return this.selection.shape.length}.bind(this)}),Object.defineProperty(this,"dtype",{get:function(){return this.selection.dtype}.bind(this),set:function(a){var b=m(a);this.selection=Z(new b(this.selection.data),this.selection.shape,this.selection.stride,this.selection.offset)}.bind(this)}),Object.defineProperty(this,"T",{get:function(){return this.transpose()}.bind(this)})};ha.prototype.pick=function(a){return new ha(this.selection.pick.apply(this.selection,arguments))},ha.prototype.lo=function(){return new ha(this.selection.lo.apply(this.selection,arguments))},ha.prototype.hi=function(){return new ha(this.selection.hi.apply(this.selection,arguments))},ha.prototype.add=function(a,b){1===arguments.length&&(b=!0);var c=b?this.clone():this;return d(a)?(_.addseq(c.selection,a),c):(a=F(a,this.dtype),_.addeq(c.selection,a.selection),c)},ha.prototype.subtract=function(a,b){1===arguments.length&&(b=!0);var c=b?this.clone():this;return d(a)?(_.subseq(c.selection,a),c):(a=F(a,this.dtype),_.subeq(c.selection,a.selection),c)},ha.prototype.multiply=function(a,b){1===arguments.length&&(b=!0);var c=b?this.clone():this;return d(a)?(_.mulseq(c.selection,a),c):(a=F(a,this.dtype),_.muleq(c.selection,a.selection),c)},ha.prototype.divide=function(a,b){1===arguments.length&&(b=!0);var c=b?this.clone():this;return d(a)?(_.divseq(c.selection,a),c):(a=F(a,this.dtype),_.diveq(c.selection,a.selection),c)},ha.prototype.max=function(){return 0===this.selection.size?null:_.sup(this.selection)},ha.prototype.min=function(){return 0===this.selection.size?null:_.inf(this.selection)},ha.prototype.equal=function(a){if(a=F(a),this.size!==a.size||this.ndim!==a.ndim)return!1;for(var b=this.ndim,c=0;b>c;c++)if(this.shape[c]!==a.shape[c])return!1;return _.all(_.eqeq(this.selection,a.selection))},ha.prototype.flatten=function(){if(1===this.shape.length)return new ha(this.selection);var a=m(this.dtype),b=g(this.tolist(),!0);return b instanceof a||(b=new a(b)),new ha(b,[this.size])},ha.prototype.reshape=function(a){if(0===arguments.length)throw new aa.ValueError("function takes at least one argument (0 given)");1===arguments.length&&d(a)&&(a=[a]),arguments.length>1&&(a=arguments);var b=j(a);if(this.size!==b)throw new aa.ValueError("total size of new array must be unchanged");var c,e,f,g,h=this.selection.shape,i=this.selection.offset,k=this.selection.stride,l=h.length,m=a.length;if(l===m){var n=!0;for(f=0;m>f;++f)if(h[f]!==a[f]){n=!1;break}if(n)return new ha(this.selection.data,h,k,i)}else if(1===l){for(c=new Array(m),f=m-1,g=1;f>=0;--f)c[f]=g,g*=a[f];for(e=i,f=0;m>f;++f)c[f]<0&&(e-=(a[f]-1)*c[f]);return new ha(this.selection.data,a,c,e)}var o=Math.min(l,m),p=!0;for(f=0;o>f;f++)if(h[f]!==a[f]){p=!1;break}if(p){for(c=new Array(m),f=0;m>f;f++)c[f]=k[f]||1;return e=i,new ha(this.selection.data,a,c,e)}return this.flatten().reshape(a)},ha.prototype.tolist=function(){return i(this.selection)},ha.prototype.toString=function(){function a(b,f){if(e(f))return f;if(d(f)){var g=String(f);return new Array(Math.max(0,c-g.length+2)).join(" ")+g}b=b||0;var h,i=ea.printThreshold,j=i/2|0;return h=f.length>i?[].concat(f.slice(0,j),[" ..."],f.slice(f.length-j)):f,new Array(b+1).join(" ")+"["+h.map(function(c,d){return a(0===d&&0===b?1:b+1,c)}).join(",")+"]"}var b=this.max(),c=String(b).length,f=/\]\,(\s*)\[/g,g="],\n$1      [",h=/\]\,(\s+)...\,(\s+)\[/g,i="],\n$2       ...\n$2      [",j=/\[\s+\[/g,k="[[",l=JSON.stringify(this.tolist(),a).replace(f,g).replace(j,k).replace(j,k).replace(h,i).slice(2,-1);switch(this.dtype){case"array":return"array(["+l+")";default:return"array(["+l+", dtype="+this.dtype+")"}},ha.prototype.inspect=ha.prototype.toString,ha.prototype.toJSON=function(){return JSON.stringify(this.tolist())},ha.prototype.clone=function(){var a=this.selection;return new ha(Z(a.data.slice(),a.shape,a.stride,a.offset))},ha.prototype.exp=function(){var a=this.clone();return _.expeq(a.selection),a},ha.prototype.pow=function(a,b){1===arguments.length&&(b=!0);var c=b?this.clone():this;return d(a)?(_.powseq(c.selection,a),c):(a=F(a,this.dtype),_.poweq(c.selection,a.selection),c)},ha.prototype.sum=function(){return _.sum(this.selection)},ha.prototype.mean=function(){return _.sum(this.selection)/j(this.shape)},ha.prototype.std=function(){var a=this.clone();_.powseq(a.selection,2);var b=this.mean(),c=Math.abs(_.sum(a.selection)/j(this.shape)-b*b);return c>0?Math.sqrt(c):0},ha.prototype.transpose=function(a){return 0===arguments.length?a=Y(this.shape.length).reverse():arguments.length>1&&(a=arguments),new ha(this.selection.transpose.apply(this.selection,a))},ha.prototype.negative=function(){var a=this.clone();return _.neg(a.selection,this.selection),a},ha.prototype.get=function(){return this.selection.get.apply(this.selection,arguments)},ha.prototype.set=function(){return this.selection.set.apply(this.selection,arguments)},ha.prototype.iteraxis=function(a,b){var c=this.shape;if(-1===a&&(a=c.length-1),0>a||a>c.length-1)throw new aa.ValueError("invalid axis");for(var d=0;d<c[a];d++){for(var e=new Array(a+1),f=0;a+1>f;f++)e[f]=f===a?d:null;var g=this.selection.pick.apply(this.selection,e),h=F(i(g),this.dtype);b(h,d)}};var ia=$({args:["array","scalar"],body:function(a,b){a=-30>a?0:a>30?1:1/(1+Math.exp(-1*b*a))}}),ja=$({args:["array","scalar","scalar"],body:function(a,b,c){a=Math.min(Math.max(b,a),c)}}),ka=$({args:["array","scalar"],body:function(a,b){a=Math.max(b*a,a)}}),la=$({args:["array"],body:function(a){a=(Math.exp(2*a)-1)/(Math.exp(2*a)+1)}});b.exports={config:ea,dtypes:fa,NdArray:ha,ndarray:Z,array:F,arange:G,reshape:w,zeros:H,ones:I,flatten:v,random:J,softmax:K,sigmoid:L,leakyRelu:N,abs:P,arccos:R,arcsin:T,arctan:V,cos:Q,sin:S,tan:U,tanh:O,clip:M,exp:x,sqrt:y,power:z,sum:A,mean:B,std:C,dot:W,add:o,subtract:r,multiply:p,divide:q,negative:E,size:j,equal:u,max:s,min:t,concatenate:X,transpose:D,errors:aa,broadcast:n,fft:ca,ops:_,pool:da,int8:function(a){return F(a,fa.int8)},uint8:function(a){return F(a,fa.uint8)},int16:function(a){return F(a,fa.int16)},uint16:function(a){return F(a,fa.uint16)},int32:function(a){return F(a,fa.int32)},uint32:function(a){return F(a,fa.uint32)},float32:function(a){return F(a,fa.float32)},float64:function(a){return F(a,fa.float64)}}},{"./errors":23,cwise:9,"iota-array":13,ndarray:20,"ndarray-fft":15,"ndarray-gemm":17,"ndarray-ops":19,"typedarray-pool":21}]},{},[24])(24)});