  ...
  describe('read', function () {
    it('should accept loaded img as input', function (done) {
      ...
      $img.onload = async function () {
        var img = await nj.images.read($img);
    ...
    it('should accept canvas as input', async function () {
      var $c = document.createElement('canvas');
      $c.height = $c.width = 28;
      var img = await nj.images.read($c);
      expect(img.shape).to.eql([28, 28]); // grayscale image from mnist
    });
